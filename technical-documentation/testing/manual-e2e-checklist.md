...
|      |             |          |           |       |
|      |             |          |           |       |
| 2026-09-07 | codex/pl-demo-studio, local 1.10.0 fork build | Windows 11 x64 | Partial | Native capture backend (screen/system audio/mic/webcam), CPU transcription, Electron renderer edits/Undo/Redo/reopen, and 1080p native export passed. OS-input HUD/tray checks skipped: native computer-use unavailable. App launches stopped after the user objected to unexpected windows. Installer built, not installed. Live AI, 4K, other aspect ratios and other operating systems remain unverified. See engineering/pl-demo-studio.md. |

| 2026-09-07 | codex/pl-demo-studio webpage-area change, rebuilt WGC helper | Windows 11 x64 | Partial - native interaction skipped | Headless built picker drag/selection passed with labeled sample media. Native D3D11 GPU pixel exclusion and 18 audio tests passed; 2702 unit tests passed, four skipped. Live browser capture, resize-stop/save recovery, and real cursor alignment skipped: native computer-use unavailable and no visible window launches per user preference. These automated checks do not establish desktop capture behavior. |

| 2026-09-07 | codex/pl-demo-studio automatic browser bounds | Windows 11 x64 | Partial - native UI skipped | Headless built picker at 1440 by 900 passed with mock bounds; native helper rebuilt and GPU/audio tests passed. Invalid HWND returns no suggestion. Live browser UI Automation bounds, WGC alignment, scrollbar exclusion, and resize behavior skipped: no native computer-use surface and visible test windows remain paused. Eligibility list does not prove browser compatibility. |
